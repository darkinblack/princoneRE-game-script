...
# "next":[0.8428835489833642, 0.9009384775808134],  "tansuojingyan":[0.6062846580406654, 0.4744525547445255],\
...
# "taback":[0.8391866913123844, 0.9124087591240876],"house":[0.6414048059149723, 0.9374348279457768],"yikuoshouqu":[0.9285274183610598, 0.7977059436913452]}
        ...
        with open("setting.json", 'r') as f:
            self.button = json.load(f)

    def pcrclick(self, name):
        pos = [int(self.button[name][0]*self.lenth),int(self.button[name][1]*self.height)]
...
titlename = "BlueStacks"


#获取句柄
hwnd = win32gui.FindWindow(0, titlename)
hwnd1 = win32gui.FindWindowEx(hwnd, None,"WindowsForms10.Window.8.app.0.2fc056_r6_ad1", None )
# hwnd = 460964
print(hwnd, hwnd1)
